...
models.MobMaster.hasMany(models.MobDrop, { foreignKey: 'mob_id', sourceKey: 'id' });
models.MobDrop.belongsTo(models.MobMaster, { foreignKey: 'mob_id', targetKey: 'id' });

// ItemMaster와 MobDrop 간의 관계
models.ItemMaster.hasMany(models.MobDrop, { foreignKey: 'item_id' , sourceKey: 'id'});
models.MobDrop.belongsTo(models.ItemMaster, { foreignKey: 'item_id' , targetKey: 'id'});
...
models.SkillMaster.hasMany(models.SkillDetail, { foreignKey: 'skill_id', sourceKey: 'id' });
models.SkillDetail.belongsTo(models.SkillMaster, { foreignKey: 'skill_id', targetKey: 'id' });

// SkillDetail과 ItemMaster 간의 관계
models.SkillDetail.belongsTo(models.ItemMaster, { foreignKey: 'item_id' , targetKey: 'id'});
models.ItemMaster.hasMany(models.SkillDetail, { foreignKey: 'item_id' , sourceKey: 'id'});
